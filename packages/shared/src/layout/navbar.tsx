...
const navigation = [
    { name: 'Terminales', href: '#', current: true },
                        ...
                        <div className="relative flex h-16 items-center justify-end">
                            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                                <div className="md:hidden">
                                    {/* Mobile menu button*/}
                                    <Disclosure.Button className=" relative inline-flex items-center justify-center rounded-md p-2 text-gray-100 hover:bg-gray-100 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                                ...
                                <div className="flex flex-1 sm:items-center justify-center md:justify-center">
                                    <div className='flex mr-7'>
                                        <div className='hidden md:flex text-gray-100 md:items-center' >Ministerio de Salud Pública</div>
                                        ...
                                        <div className='hidden md:flex text-gray-100 md:items-center' >República del Ecuador</div>
                                    </div>
                                            ...
                                            {navigation.map((item) => (
                                                <a
                                                    ...
                                                    className={classNames(
                                                        item.current ? 'bg-gray-100 text-black' : 'text-gray-300 hover:bg-gray-700 hover:text-white',
