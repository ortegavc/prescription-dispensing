...
export type ColaboradorEgreso = {
  ...
  id: Scalars["Int"]["output"];
  identificacion: Scalars["Float"]["output"];
  nombre?: Maybe<Scalars["String"]["output"]>;
...
export type Egreso = {
  ...
  proveedordestino?: Maybe<Scalars["String"]["output"]>;
  ruc?: Maybe<Scalars["String"]["output"]>;
...
export type EgresoCreateDetalleInput = {
  ...
  proveedordestino?: InputMaybe<Scalars["String"]["input"]>;
...
export type ProductoStockEntidadAdmin = {
  ...
  activo: Scalars["Int"]["output"];
  consumopromediomensual: Scalars["Float"]["output"];
  costoinicial: Scalars["Float"]["output"];
  ...
  stockcomprometido: Scalars["Float"]["output"];
  stockinicial: Scalars["Float"]["output"];
  valorpromedio: Scalars["Float"]["output"];
  valortotal?: Maybe<Scalars["Float"]["output"]>;
};
...
export function useTerminalUsuarioListQuery(
  baseOptions: Apollo.QueryHookOptions<
    TerminalUsuarioListQuery,
    TerminalUsuarioListQueryVariables
  >
) {
  ...
  return Apollo.useQuery<
    TerminalUsuarioListQuery,
    TerminalUsuarioListQueryVariables
  >(TerminalUsuarioListDocument, options);
}
...
export type TerminalUsuarioListQueryHookResult = ReturnType<
  typeof useTerminalUsuarioListQuery
>;
export type TerminalUsuarioListLazyQueryHookResult = ReturnType<
  typeof useTerminalUsuarioListLazyQuery
>;
export type TerminalUsuarioListQueryResult = Apollo.QueryResult<
  TerminalUsuarioListQuery,
  TerminalUsuarioListQueryVariables
>;
